...
class Unet(nn.Module):
    def __init__(self, in_channels):
        ...
        for i in range(len(self.mid_chanels) - 1):
            self.mids.append(MidBlock(self.mid_chanels[i], self.mid_chanels[i + 1], self.t_emb_dim, num_heads=4))
    ...
    def foward(self, x, t):
        ...
        for up in self.ups:
            down_outs = down_outs.pop()
            print(out, down_outs.shape)
            out = up(out, down_outs, t_emb)
